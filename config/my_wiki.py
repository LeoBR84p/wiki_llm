...
_MODEL_ID = os.environ.get('WIKI_MODEL_ID', 'anthropic/claude-sonnet-4-5')
...
config = WikiConfig(
    ...
    objects=[
        ObjectTypeConfig(
            ...
            slug='notes',
            wiki_subdir='notes',
            prompt_generate=_PROMPTS / 'wiki_summary_notes.md',
            prompt_evaluate=_PROMPTS / 'wiki_evaluate_notes.md',
            frontmatter_fields=[],
            max_rounds=2,
        ),
    ],
